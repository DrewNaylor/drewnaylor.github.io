...
1. Install graphics drivers/packages
  ...
  C. "xf86-video-vmware"/"vmwgfx" since we're using VMware, though the instructions should work for other X11 drivers; might end up giving up on installing this in VMware and just use Hyper-V, because this is really complicated and MESA-LOADER still can't find the correct driver. (https://www.linuxfromscratch.org/blfs/view/svn/x/x7driver.html#xorg-vmware-driver)
